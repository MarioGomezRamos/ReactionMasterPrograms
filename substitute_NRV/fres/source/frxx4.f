...
C
 ...
 1270 FORMAT( /,1X,118('#'),/,' #',116X,'#',/
     X           ,' #',' Total SPIN and PARITY =',F8.1,1X,A1,',',I5,
 ...
 1271 FORMAT(/' Total SPIN, PARITY =',F8.1,1X,A1,',',I5,
     X' chs,',I5,' cc.  Rmin & Coul turning =',2f7.1)
     	   endif
      IF(NCH.EQ.0) RETURN
C
...
!           call flush(6)
	   ...
	   theorycm = theory
           if(idir==0.and.kq1==0.and.data_lab(id)) 
